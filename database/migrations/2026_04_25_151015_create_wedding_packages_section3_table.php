...
class CreateWeddingPackagesSection3Table extends Migration
{
    public function up()
    {
        Schema::create('wedding_packages_section3', function (Blueprint $table) {
            $table->id();
            $table->string('title')->default('Premium Package');
    ...
    {
        Schema::dropIfExists('wedding_packages_section3');
    }
}